...
/// Land Acquisition Detail Component
///
/// Two main states: Not Applicable or Applicable (with sub-states)
class LandAcquisitionDetailComponent extends BaseReviewComponent {
  const LandAcquisitionDetailComponent({
    super.key,
  ...
  Widget buildContent(BuildContext context) {
    final status = data['la_status']?.toString().toLowerCase() ?? '';
  ...
  Widget _buildApplicableView() {
    return Column(
      ...
      children: [
        buildSectionHeader('Land Acquisition Status'),
